  ...
  const products = [
    {
      ...
      price: '대여중: 3, 대여제공: 15',
      likes: '#심플베이직, #유니크',
      image: require('./assets/AsaP_image/daeun_img.jpg'),
    },
    {
      id: '2',
      name: '이구역의 옷짱은 허나영',
      price: '대여중: 1, 대여제공: 22',
      likes: '#러블리, #오피스룩',
      image: require('./assets/AsaP_image/nayoung.jpg'),
    },
    {
      id: '3',
      name: '나는야 김김나영',
      price: '대여중: 5, 대여제공: 2',
      likes: '#모던 미니멀, #심플 베이직',
      image: require('./assets/AsaP_image/nayoung2.jpg'),
    },
    {
      id: '4',
      name: '나는야 이채연',
      price: '대여중: 1, 대여제공: 1',
      likes: '#캐주얼, #심플베이직',
      image: require('./assets/AsaP_image/chay.jpg'),
    },
  ];
  return (
